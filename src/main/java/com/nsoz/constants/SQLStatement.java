...
public class SQLStatement {
    ...
    public static final String GET_USER = "SELECT `status`, `id`, `luong`, `last_attendance_at`, `received_first_gift`, `password`, `ip_address`, `level_reward`, `role`, `online`, `ban_until`, `activated` FROM `users` WHERE `username` = ?;";
    ...
    public static final String UPDATE_VND = "UPDATE `users` SET `vnd` = ? WHERE `id` = ? LIMIT 1;";
   
    public static final String ADD_VND = "UPDATE `users` SET `vnd` = `vnd` + ? WHERE `id` = ? LIMIT 1;";
