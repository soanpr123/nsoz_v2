...
public class RandomItem {
    ...
    public static void init() {
        ...
        SUMMER.add(2, ItemName.TRE);
        SUMMER.add(3, ItemName.DAY);
        SUMMER.add(5, ItemName.GIAY2);
        SUMMER.add(5, ItemName.VAI);
...
*/
        ...
        LANG_CO.add(1.5, ItemName.CHUYEN_TINH_THACH);
        ...
        LANG_TRUYEN_THUYET.add(3, ItemName.THONG_LINH_THAO);
        LANG_TRUYEN_THUYET.add(2, ItemName.THUY_THACH);
        LANG_TRUYEN_THUYET.add(2, ItemName.PHONG_THACH);
        LANG_TRUYEN_THUYET.add(2, ItemName.HOA_THACH);
        LANG_TRUYEN_THUYET.add(7, ItemName.LUC_THANH_HOA);
        LANG_TRUYEN_THUYET.add(7, ItemName.TAM_LUC_DIEP);
        LANG_TRUYEN_THUYET.add(7, ItemName.XICH_LAN_HOA_);
        ...
        VDMQ.add(4, ItemName.BO_DIEU_KHIEN);
        VDMQ.add(4, ItemName.DONG_CO_V_POWER);
        VDMQ.add(4, ItemName.DINH_VI);
        VDMQ.add(4, ItemName.BINH_NITRO);
        VDMQ.add(5, ItemName.CHUYEN_TINH_THACH);
        VDMQ.add(3, ItemName.TU_TINH_THACH_SO_CAP);
        VDMQ.add(2, ItemName.TU_TINH_THACH_TRUNG_CAP);
        VDMQ.add(3, ItemName.LUC_THANH_HOA);
        VDMQ.add(2, ItemName.TU_LINH_LIEN_HOA);
        ...
        BOSS_VDMQ.add(10, ItemName.BAT_BAO);
        BOSS_VDMQ.add(5, ItemName.RUONG_BACH_NGAN);
        BOSS_VDMQ.add(40, ItemName.SACH_VO_CONG_ENKO_BAKUSATSU);
        BOSS_VDMQ.add(40, ItemName.SACH_VO_CONG_TSUMABENI);
        BOSS_VDMQ.add(40, ItemName.SACH_VO_CONG_SHABONDAMA);
        BOSS_VDMQ.add(40, ItemName.SACH_VO_CONG_KOGORASERU);
        BOSS_VDMQ.add(40, ItemName.SACH_VO_CONG_RAIJIN);
        BOSS_VDMQ.add(40, ItemName.SACH_VO_CONG_KAMIKAZE);
